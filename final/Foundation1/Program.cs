...
class Program {
    static void Main(string[] args) {
        ...
        video2.Comments.Add(new Comment("Commenter 2", "second comment on video 2"));
        ...
        video3.Comments.Add(new Comment("Commenter 2", "second comment on video 3"));
        video3.Comments.Add(new Comment("Commenter 3", "Another comment on video 3"));
        videos.Add(video3);
